...
ggplot(data, aes(x = x, y = y)) +
  ...
  geom_abline(intercept = 20, slope = 5, linetype = "dashed", colour = "red") +
  geom_abline(intercept = 20, slope = 15, linetype = "dashed", colour = "green") +
  geom_abline(intercept = 30, slope = 10, linetype = "dashed", colour = "blue") +
...
Consider the association between **social media usage** (the dependent variable) and the **number of sleeping hours** (the independent variable). 
