...
Importantly, we can use the results of the CLT to calculate CIs for sample mean even when the sample itself is not normally distributed. 

Using `paragraph_informativeness`, calculate 90%, 95%, and 99% Z-based confidence intervals for the sample mean.
